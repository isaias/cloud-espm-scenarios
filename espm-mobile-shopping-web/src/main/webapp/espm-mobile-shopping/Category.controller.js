sap.ui.controller("espm-mobile-shopping.Category", {
	...
	loadDataCloud : function() {
		...
		newUrl = sap.app.config.smpUrl + sap.app.config.connUrl + sap.app.config.couldAppName;
		...
		if (sap.app.config.useWeb == true) {
			...
			sServiceUrl = sap.app.config.smpUrl + sap.app.config.reqRepUrl + sap.app.config.couldAppName;
		}
